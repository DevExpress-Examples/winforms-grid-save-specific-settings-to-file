...
Namespace WindowsFormsApplication1
    ...
    Public Class GridLayoutSerializer
        ...
        Public Shared Sub SaveLayout(ByVal view As ColumnView, ByVal stream As Stream)
            Dim serializer As GridLayoutSerializer = New GridLayoutSerializer()
        ...
        Protected Function GetFilterProps(ByVal view As ColumnView) As XtraPropertyInfoCollection
            Dim store As XtraPropertyInfoCollection = New XtraPropertyInfoCollection()
            ...
            Dim helper As SerializeHelper = New SerializeHelper(view)
            ...
            For Each prop As PropertyDescriptor In propList
                ...
                Dim p As SerializablePropertyDescriptorPair = New SerializablePropertyDescriptorPair(prop, newXtraSerializableProperty)
